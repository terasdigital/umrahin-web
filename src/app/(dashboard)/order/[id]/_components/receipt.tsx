...
const Receipt = ({
  ...
  const { totalPrice, tax, service, finalPrice } = usePricing(orderMenu);
  ...
  return (
    <div className="relative">
      ...
      >
        <h4 className="text-2xl font-bold text-center pb-4 border-b border-dash">
          Umrahin
        </h4>
        <div className="py-4 border-b border-dash text-sm space-y-2">
          <p>
        ...
        <div className="flex flex-col gap-2 py-4 border-b border-dash text-sm">
          {orderMenu?.map((item) => (
